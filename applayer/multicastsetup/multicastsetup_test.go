...
func TestMulticastSetup(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			Bytes: []byte{0x02, 0x02, 0x04, 0x03, 0x02, 0x01, 0x08, 0x07, 0x06, 0x05, 0x04, 0x03, 0x02, 0x01, 0x08, 0x07, 0x06, 0x05, 0x04, 0x03, 0x02, 0x01, 0x64, 0x00, 0x00, 0x00, 0xc8, 0x00, 0x00, 0x00},
		},
		{
